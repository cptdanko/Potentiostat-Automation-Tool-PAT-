...
public class CollectionFileListener implements FileAlterationListener, Serializable {
    ...
    private PATFileWatcher watcher = null;
    ...
    public CollectionFileListener(boolean clearOnStart,
                                PATFileWatcher fileWatcher,
                                String finishFile) 
    {
        this.clearOnStart = clearOnStart;
        watcher = fileWatcher;
        this.endFilename = finishFile;
    }
    ...
    public void onFileCreate(final File file) {
        ...
        if(file.getName().equals(this.endFilename))
        {
            createdFiles.add(file);
            List<File> files = (List<File>)this.getCreatedFiles();
            this.watcher.watchFinished(files);
        }
